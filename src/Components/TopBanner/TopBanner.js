            ...
            <div className='container'>
                ...
                <div className='row'>
                    ...
                    <div style={{borderRadius:'50px'}} className='col m-2 bg-white m-2'>
                        ...
                        <a href='/' className='text-decoration-none text-dark fw-bold ps-2'>Daraz Mall</a>
                    </div>
                    <div style={{borderRadius:'50px'}} className='col m-2 bg-white m-2'>
                        <img src={feature4} width='50' className='img-fluid py-1' alt=''/>
                        <a href='/' className='text-decoration-none text-dark fw-bold ps-2'>Digital Service</a>
                    </div>
                </div>
            </div>
        </div>
